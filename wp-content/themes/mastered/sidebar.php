...
<form role="search" class="blog-search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
	<label class="search-blog-label screen-reader-text" for="s">Search the magazine:</label>
...
<ul class="sidebar-archives side-list">
	<li class="sidebar-title">Magazine Archives</li>
	<?php wp_get_archives(); ?>
</ul>
<ul class="sidebar-categories side-list">
	<li class="sidebar-title">Magazine Categories</li>
